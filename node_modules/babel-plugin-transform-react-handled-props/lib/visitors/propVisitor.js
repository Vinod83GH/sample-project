...
var propVisitor = {
  AssignmentExpression: function AssignmentExpression(path, state) {
    ...
    var right = _lodash2.default.get(path, 'node.right');
  ...
  ClassProperty: function ClassProperty(path, state) {
    var expression = (0, _util.getClassDeclaration)(path);
    var identifier = (0, _util.getEntryIdentifier)(expression);
    var value = _lodash2.default.get(path, 'node.value');
