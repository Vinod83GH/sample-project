...
Table.propTypes = {
  ...
  columns: PropTypes.oneOf(UV5UI.WIDTHS),
  ...
  size: PropTypes.oneOf(_.without(UV5UI.SIZES, 'mini', 'tiny', 'medium', 'big', 'huge', 'massive')),
  ...
  textAlign: PropTypes.oneOf(_.without(UV5UI.TEXT_ALIGNMENTS, 'justified')),
