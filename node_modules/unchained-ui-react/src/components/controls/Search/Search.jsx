...
export default class Search extends Component {
  static propTypes = {
    ...
    size: PropTypes.oneOf(_.without(UV5UI.SIZES, 'medium')),

    /** The Accessibility label. */
    ariaLabel: PropTypes.string,

    /** A search input can have a placeholder */
  ...
  renderSearchInput = rest => {
    ...
    return Input.create(input, { defaultProps: {
      ...rest,
      icon,
      input: { className: 'prompt', tabIndex: '0', autoComplete: 'off', 'aria-label': ariaLabel, placeholder, value },
  ...
  renderCategories = () => {
    ...
    return _.map(categories, ({ childKey, ...category }, name, index) => { // eslint-disable-line no-unused-vars-rest/no-unused-vars
      const categoryProps = {
  ...
  renderResultsMenu = () => {
    ...
    return <SearchResults className={resultsClasses}>{menuContent}</SearchResults>; // eslint-disable-line consistent-return
  }
