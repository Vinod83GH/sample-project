...
class Button extends Component {
  static propTypes = {
    ...
    size: PropTypes.oneOf(UV5UI.SIZES),
  ...
  computeElementType = () => { // eslint-disable-line consistent-return
    const {
      attached,
      label
    } = this.props;
  ...
  computeTabIndex = ElementType => { // eslint-disable-line consistent-return
    const {
      disabled,
      tabIndex
    } = this.props;
  ...
  render() {
    ...
    const baseClasses = cx(
      ...
      useKeyOnly(icon === true || icon && (labelPosition || !children && !content), 'icon'), // eslint-disable-line no-mixed-operators
