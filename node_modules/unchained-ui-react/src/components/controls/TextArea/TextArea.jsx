...
class TextArea extends Component {
  ...
  componentDidUpdate(prevProps, prevState) { // eslint-disable-line no-unused-vars-rest/no-unused-vars
    ...
    if (this.props.autoHeight && !prevProps.autoHeight || prevProps.value !== this.props.value) { // eslint-disable-line no-mixed-operators
      this.updateHeight();
    }
  }
  ...
  updateHeight = () => {
    ...
    this.ref.style.height = (this.ref.scrollHeight + borderTopWidth + borderBottomWidth) + 'px'; // eslint-disable-line prefer-template
  };
