...
export default class Rating extends Component {
  static propTypes = {
    ...
    defaultRating: PropTypes.oneOfType([ // eslint-disable-line react/no-unused-prop-types
      PropTypes.number,
      PropTypes.string,
    ]),
    ...
    rating: PropTypes.oneOfType([ // eslint-disable-line react/no-unused-prop-types
      PropTypes.number,
      PropTypes.string,
    ]),
  ...
  render() {
    ...
    return (
      <ElementType {...rest} className={classes} role={'radiogroup'} name={'rating'} aria-label={ariaLabel} onMouseLeave={this.handleMouseLeave}>
        {_.times(maxRating, (i) => (
          <RatingIcon
            active={rating >= i + 1}
