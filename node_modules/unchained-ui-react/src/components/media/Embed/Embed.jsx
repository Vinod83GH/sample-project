...
export default class Embed extends Component {
  static propTypes = {
    ...
    defaultActive: PropTypes.bool, // eslint-disable-line react/no-unused-prop-types
  ...
  render() {
    ...
    return (
      <ElementType {...rest} className={classes} onClick={this.handleClick}>
        {Icon.create(icon)}
        {placeholder && <img className={'placeholder'} src={placeholder} alt={'Ember Placeholder'} />}
        {this.renderEmbed()}
      </ElementType>
    );
  }
