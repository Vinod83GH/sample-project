...
class Menu extends Component {
  static propTypes = {
    ...
    activeIndex: PropTypes.number, // eslint-disable-line react/no-unused-prop-types
    ...
    defaultActiveIndex: PropTypes.number, // eslint-disable-line react/no-unused-prop-types
     ...
     */
    onItemClick: customPropTypes.every([ // eslint-disable-line react/no-unused-prop-types
    ...
    size: PropTypes.oneOf(_.without(UV5UI.SIZES, 'medium', 'big')),
    ...
    widths: PropTypes.oneOf(UV5UI.WIDTHS),
  };

  static _meta = {
    name: 'Menu',
    type: META.TYPES.NAVIGATION,
  };
