...
export default class MenuItem extends Component {
  ...
  render() {
    ...
    const classes = cx(
      ...
      useKeyOnly(icon === true || icon && !(name || content), 'icon'), // eslint-disable-line no-mixed-operators
    ...
    const ElementType = getElementType(MenuItem, this.props, () => { // eslint-disable-line consistent-return
      if (onClick) return 'a';
    });
