...
.ui.label > .icon {
  width: auto;
  margin: 0 $labelIconDistance 0 0;
}
...
.ui.label > .detail .icon {
  margin: 0 $labelDetailIconDistance 0 0;
}
...
.ui.labels > .label {
  margin: 0 $labelGroupHorizontalMargin $labelGroupVerticalMargin 0;
}
...
.ui.image.label .detail {
  ...
  border-radius: 0 $labelImageLabelBorderRadius $labelImageLabelBorderRadius 0;
}
...
.ui.tag.label {
  ...
  border-radius: 0 $labelBorderRadius $labelBorderRadius 0;
...
.ui.ribbon.label::after {
  ...
  background-color: transparent !important;
  border-style: solid;
  border-width: 0 $labelRibbonTriangleSize $labelRibbonTriangleSize 0;
...
.ui[class*="right ribbon"].label {
  ...
  border-radius: $labelBorderRadius 0 0 $labelBorderRadius;
}
.ui[class*="right ribbon"].label::after {
  left: auto;
  right: 0;
  border-style: solid;
  border-width: $labelRibbonTriangleSize $labelRibbonTriangleSize 0 0;
  border-color: transparent;
  border-top-color: inherit;
}
...
.ui.attached.label {
  ...
  border-radius: $labelAttachedCornerBorderRadius $labelAttachedCornerBorderRadius 0 0;
}
.ui[class*="bottom attached"].label {
  top: auto;
  bottom: 0;
  border-radius: 0 0 $labelAttachedCornerBorderRadius $labelAttachedCornerBorderRadius;
}

.ui[class*="top left attached"].label {
  width: auto;
  margin-top: 0 !important;
  border-radius: $labelAttachedCornerBorderRadius 0 $labelAttachedBorderRadius 0;
}
...
.ui[class*="top right attached"].label {
  ...
  left: auto;
  right: 0;
  border-radius: 0 $labelAttachedCornerBorderRadius 0 $labelAttachedBorderRadius;
}
.ui[class*="bottom left attached"].label {
  width: auto;
  top: auto;
  bottom: 0;
  border-radius: 0 $labelAttachedBorderRadius 0 $labelAttachedCornerBorderRadius;
}
.ui[class*="bottom right attached"].label {
  ...
  right: 0;
  width: auto;
  border-radius: $labelAttachedBorderRadius 0 $labelAttachedCornerBorderRadius 0;
}
...
.ui.horizontal.label {
  margin: 0 $labelHorizontalLabelMargin 0 0;
...
.ui[class*="pointing above"].label::before {
  border-width: $labelBorderWidth 0 0 $labelBorderWidth;
...
.ui[class*="pointing below"].label::before {
  border-width: 0 $labelBorderWidth $labelBorderWidth 0;
  right: auto;
  transform: translateX(-50%) translateY(-50%) rotate(45deg);
  top: 100%;
  left: 50%;
...
.ui[class*="left pointing"].label::before {
  border-width: 0 0 $labelBorderWidth $labelBorderWidth;
  transform: translateX(-50%) translateY(-50%) rotate(45deg);
  bottom: auto;
  right: auto;
  top: 50%;
...
.ui[class*="right pointing"].label::before {
  border-width: $labelBorderWidth $labelBorderWidth 0 0;
  transform: translateX(50%) translateY(-50%) rotate(45deg);
  top: 50%;
  right: 0%;
  bottom: auto;
...
.ui.floating.label {
  ...
  left: 100%;
  margin: 0 0 0 $labelFloatingLeftOffset !important;
}
