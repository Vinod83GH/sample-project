...
.ui.mini.text.loader {
  ...
  padding-top: calc(#{$loaderMini} + #{$loaderTextDistance});
}
.ui.tiny.text.loader {
  min-width: $loaderTiny;
  padding-top: calc(#{$loaderTiny} + #{$loaderTextDistance});
}
.ui.small.text.loader {
  min-width: $loaderSmall;
  padding-top: calc(#{$loaderSmall} + #{$loaderTextDistance});
}
.ui.text.loader {
  min-width: $loaderMedium;
  padding-top: calc(#{$loaderMedium} + #{$loaderTextDistance});
}
.ui.large.text.loader {
  min-width: $loaderLarge;
  padding-top: calc(#{$loaderLarge} + #{$loaderTextDistance});
}
.ui.big.text.loader {
  min-width: $loaderBig;
  padding-top: calc(#{$loaderBig} + #{$loaderTextDistance});
}
.ui.huge.text.loader {
  min-width: $loaderHuge;
  padding-top: calc(#{$loaderHuge} + #{$loaderTextDistance});
}
.ui.massive.text.loader {
  min-width: $loaderMassive;
  padding-top: calc(#{$loaderMassive} + #{$loaderTextDistance});
}
