...
export const suggest = suggestions => {
  return (props, propName, componentName) => {
    ...
    return new Error([ // eslint-disable-line consistent-return
...
export const some = (validators) => {
  return (props, propName, componentName, ...rest) => { // eslint-disable-line consistent-return
    if (!Array.isArray(validators)) {
      throw new Error([
...
export const onlyProp = possible => {
  return (props, propName, componentName) => {
    ...
    if (invalid.length > 0) {
      return new Error(`\`${propName}\` prop in \`${componentName}\` has invalid values: \`${invalid.join('`, `')}\`.`); // eslint-disable-line consistent-return
    }
  };
};
