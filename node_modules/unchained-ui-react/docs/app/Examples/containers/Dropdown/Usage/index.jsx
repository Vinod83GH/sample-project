...
const DropdownUsageExamples = () => (
  <ExampleSection title={'Usage'}>
    <ComponentExample
      ...
      examplePath={'containers/Dropdown/Usage/DropdownExampleOpenOnFocus'}
    />
    <ComponentExample
      title={'Close On Blur'}
      description={'A dropdown that closes when it blurs'}
      examplePath={'containers/Dropdown/Usage/DropdownExampleCloseOnBlur'}
    />
    <ComponentExample
      title={'Close On Change'}
      description={'A multiple selection dropdown can close when the user changes its value.'}
      examplePath={'containers/Dropdown/Usage/DropdownExampleCloseOnChange'}
    />
    <ComponentExample
      title={'Uncontrolled'}
      description={'A dropdown can behave like an uncontrolled input.'}
      examplePath={'containers/Dropdown/Usage/DropdownExampleUncontrolled'}
    />
    <ComponentExample
      title={'No Results Message'}
      description={'You can change the no results message.'}
      examplePath={'containers/Dropdown/Usage/DropdownExampleCustomNoResultsMessage'}
    />
    <ComponentExample
      description={'You can remove the no results message.'}
      examplePath={'containers/Dropdown/Usage/DropdownExampleRemoveNoResultsMessage'}
    />
    <ComponentExample
      title={'Remote'}
      description="A dropdown's options can be controlled from outside based on search change."
      examplePath={'containers/Dropdown/Usage/DropdownExampleRemote'}
    />
    <ComponentExample
      title={'Allow Additions'}
      description={'Using allowAdditions gives users the ability to add their own options.'}
      examplePath={'containers/Dropdown/Usage/DropdownExampleAllowAdditions'}
    />
    <ComponentExample
      description={'allowAdditions can be used with multiple.'}
      examplePath={'containers/Dropdown/Usage/DropdownExampleMultipleAllowAdditions'}
    />
    <ComponentExample
      description={'You can provide a custom additionLabel as a string.'}
      examplePath={'containers/Dropdown/Usage/DropdownExampleAdditionLabelString'}
    />
    <ComponentExample
      description={'Or provide additionLabel as a component.'}
      examplePath={'containers/Dropdown/Usage/DropdownExampleAdditionLabelComponent'}
    />
    <ComponentExample
      title={'Trigger'}
      description={'A dropdown can render a node in place of the text.'}
      examplePath={'containers/Dropdown/Usage/DropdownExampleTrigger'}
    />

    <ComponentExample
      examplePath={'containers/Dropdown/Usage/DropdownExampleTriggerImage'}
    />
    <ComponentExample
      title={'Multiple Custom Label'}
      description={'A "multiple" dropdown can render customized label for selected items.'}
      examplePath={'containers/Dropdown/Usage/DropdownExampleMultipleCustomLabel'}
    />
    <ComponentExample
      title={'Item Content'}
      description={'A dropdown item can be rendered differently inside the menu.'}
      examplePath={'containers/Dropdown/Usage/DropdownExampleItemContent'}
    />
  </ExampleSection>
);
